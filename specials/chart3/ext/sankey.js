...
(function() {
	...
	FlowLine = (function() {
		...
		FlowLine.prototype.highlight = function(left, right) {
			...
			if (left) {
				...
				this.left_box.number_label.attr('opacity',0);
			}
			if (right) {
				this.right_label.toFront();
				this.right_box.number_label.attr('opacity',0);
	...
	TransformationBox = (function() {
		...
		TransformationBox.prototype.descriptionLabelText = function() {
			switch(this.label_text) {
				case "Biological, Agricultural & Environmental Life Sciences":
					return "Bio., Ag., and Env. Sciences";
				case "Biological, Agricultural & Other Life Scientists":
					return "Bio., Ag., and Env. Sciences";
				case "Computer & Mathematical Sciences":
					return "Comp. Sci. and Math";
				case "Computer & Mathematical Scientists":
					return "Comp Sci. and Math";	
				case "Social & Related Sciences":
					return "Social Sciences";
				case "Physical & Related Sciences":
					return "Physical Sciences";
				case "S & E Related Occupations":
					return "S & E Occupations";
				case "Health-Related Occupations":
					return "Health";
				case "Social & Related Scientists":
					return "Social Sciences";
				case "Physical & Related Scientists":
					return "Physical Sciences";
				case "Non-S & E Occupations":
					return "Non-Science Occupations";
				case "Psychologists":
					return "Psychology";
				case "Engineers":
					return "Engineering";
		...
		TransformationBox.prototype.labelPositionX = function() {
			var x_delta = 8;
			if (this.is_left_box()) {
				return this.x - x_delta;
			}
			if (this.is_right_box()) {
				return this.x + this.sankey.box_width + x_delta;
			}
		...
		TransformationBox.prototype.hover_start = function() {
		 ...
		 // this.number_label.attr({fill:'white'});
