...
var padding = 4;
  ...
  for (var j = 0; j < data.length; j++) {
    ...
    data[j].radius = 10;//size of bubbles
...
$("label.ratingBtn").click(function() {
 ...
 function draw(varname) {
  ...
  var centers = getCenters(varname, [width, height+200]);//seperates the bubble blobs
...
//        return "Assessment ID: " + d.objectName + "</br>Political Affiliation: " + d.Pol + "</br>CNN: " + d.CNN + "</br>Fox: " + d.Fox;
